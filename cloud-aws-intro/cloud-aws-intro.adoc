...
A security group is a set of rules that control the traffic for your instance. 
...
[source,console]
....
ssh -i ~/.ssh/labsuser.pem ubuntu@34.211.103.212
....
...
[source,console]
....
ssh -i labsuser.pem ubuntu@34.211.103.212
....
...
* Install Nginx web server through command.  
[source,shell]
```
sudo apt install nginx
```

* The files for the Nginx web server are in `/var/www/html`. Edit those files to change what appears on the website.
