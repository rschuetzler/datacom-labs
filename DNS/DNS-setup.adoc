...
3. What is an example of a TLD nameserver?
...
11. Look up the list of ICANN-era top-level domains.  What is your favorite new TLD?

12. When you update DNS for Internet domains, it can take up to 24 hours for your changes to make their way across the network.  Why?
