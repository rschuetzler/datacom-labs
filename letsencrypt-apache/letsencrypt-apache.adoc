...
[source,console]
----
[ec2-user@ip...] sudo dnf install openssl mod_ssl
[ec2-user@ip...] sudo dnf install python3 augeas-libs pip
[ec2-user@ip...] sudo python3 -m venv /opt/certbot
[ec2-user@ip...] sudo /opt/certbot/bin/pip install --upgrade pip
[ec2-user@ip...] sudo /opt/certbot/bin/pip install certbot-apache
[ec2-user@ip...] sudo ln -s /opt/certbot/bin/certbot /usr/bin/certbot
[ec2-user@ip...] sudo certbot --apache
----

== Setting up Certbot (Amazon Linux 2)
